...
using EshopManager.Application.Features.DocumentTypes.Commands.Delete;
using EshopManager.Application.Features.DocumentTypes.Queries.Export;
...
namespace EshopManager.Server.Controllers.Utilities.Misc
{
