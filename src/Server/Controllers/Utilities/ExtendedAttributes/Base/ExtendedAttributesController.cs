...
using EshopManager.Application.Features.ExtendedAttributes.Commands.AddEdit;
using EshopManager.Application.Features.ExtendedAttributes.Commands.Delete;
using EshopManager.Application.Features.ExtendedAttributes.Queries.Export;
using EshopManager.Application.Features.ExtendedAttributes.Queries.GetAll;
using EshopManager.Application.Features.ExtendedAttributes.Queries.GetAllByEntityId;
using EshopManager.Application.Features.ExtendedAttributes.Queries.GetById;
using EshopManager.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace EshopManager.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
