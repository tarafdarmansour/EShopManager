...
using EshopManager.Client.Extensions;
using EshopManager.Client.Infrastructure.Managers.ExtendedAttribute;
using EshopManager.Domain.Contracts;
using EshopManager.Domain.Enums;
using EshopManager.Shared.Constants.Application;
...
namespace EshopManager.Client.Shared.Components
{
