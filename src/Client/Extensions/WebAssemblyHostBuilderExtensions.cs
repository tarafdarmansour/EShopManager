...
using EshopManager.Client.Infrastructure.Authentication;
using EshopManager.Client.Infrastructure.Managers;
using EshopManager.Client.Infrastructure.Managers.Preferences;
...
using EshopManager.Domain.Entities.ExtendedAttributes;
using EshopManager.Domain.Entities.Misc;
using Toolbelt.Blazor.Extensions.DependencyInjection;

namespace EshopManager.Client.Extensions
{
