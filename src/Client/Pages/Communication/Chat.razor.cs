...
using EshopManager.Client.Infrastructure.Managers.Communication;
using EshopManager.Shared.Constants.Storage;

namespace EshopManager.Client.Pages.Communication
{
